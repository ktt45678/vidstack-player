import {
  F as FileDownloadInfo,
  L as LogLevel,
  j as MediaCanPlayEvent,
  g as MediaControlsChangeEvent,
  e as MediaEvents,
  h as MediaFullscreenChangeEvent,
  M as MediaPlayerProps,
  b as MediaPlayerState,
  i as MediaRateChangeEvent,
  f as MediaTextTrackChangeEvent,
  k as MediaTimeUpdateEvent,
  c as MediaViewType,
  l as MediaVolumeChangeEvent,
  d as PlayerSrc,
  P as PlyrLayoutProps,
  a as PlyrLayoutTranslations,
  T as TextTrackInit,
} from '../dist/types/vidstack-CRJAuuE5.js';

import '../dist/types/vidstack-Fi-_u60q.js';

import { MediaPlayerElement, MediaPlyrLayoutElement, MediaProviderElement } from '../elements.js';
...
declare class Plyr implements PlyrProps, PlyrMethods {
  ...
  loop: boolean;
  poster: string;
  get type(): 'video' | 'audio' | '' | 'google-cast' | 'dash' | 'hls' | 'youtube' | 'vimeo';
  get isHTML5(): boolean;
  get isEmbed(): boolean;
  get buffered(): number;
  get stopped(): boolean;
...
export {
  ...
  type PlyrI18nConfig,
  type PlyrKeyboardConfig,
  type PlyrMethods,
  type PlyrProps,
  type PlyrSource,
  type PlyrStorageConfig,
  type PlyrTarget,
};
