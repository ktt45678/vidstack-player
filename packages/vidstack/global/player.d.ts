...
declare class VidstackPlayer {
  static create({
    ...
    tracks,
    ...props
  }: VidstackPlayerConfig): Promise<MediaPlayerElement>;
}
...
export {
  PlyrLayout,
  VidstackPlayer,
  type VidstackPlayerConfig,
  VidstackPlayerLayout,
  type VidstackPlayerLayoutLoader,
  type VidstackPlayerTarget,
};
